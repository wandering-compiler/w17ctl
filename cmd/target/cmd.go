...
type Cmd struct {
	...
	Deploy     DeployCmd     `cmd:"" help:"Optional deploy targets (deploy_targets[]) — opt kubernetes into generated deploy/prod/k8s.yaml. Docker is always emitted and is not listed here. Re-signs on save."`
